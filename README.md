...
1. IBM Watson Machine Learning instance.
2. IBM Cloud Annotations for localization detection.
3. IBM Cloud Object Storage for storing data used to train our machine learning model.
